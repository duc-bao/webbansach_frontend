...
import { Avatar, Box, Button, FormControl, FormControlLabel, FormLabel, Grid, Radio, RadioGroup, Tab, TextField, Tooltip } from "@mui/material";
...
import { checkPassword, checkPhoneNumber, checkRepeatPassword } from "../utils/Validation";
...
export const ProfilePage: React.FC<ProfilePageProps> = (props) => {
    ...
    function handleImageUpload(event: React.ChangeEvent<HTMLInputElement>) {
        ...
        if(inputElement.files && inputElement.files.length > 0){
            ...
            reader.onload = (e:any) =>{
                ...
                setPreviewAvatar(URL.createObjectURL(selectFile));
	...
	function handleSubmitAvatar() {
		const token = localStorage.getItem("token");
		toast.promise(
			fetch("http://localhost:8080/user/change-avatar", {
				method: "PUT",
				headers: {
					Authorization: `Bearer ${token}`,
					"content-type": "application/json",
