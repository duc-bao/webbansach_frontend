import { FormControl, Icon, InputLabel, MenuItem, NativeSelect, Select, SelectChangeEvent, TextField } from "@mui/material";
						...
						<FormControl sx={{ m: 1, minWidth: 120 }} size='small'>
							...
							>
								...
								{genres?.map((genre, index) => {
									return (
										<MenuItem value={genre.idCategory} key={index}>
											{genre.nameCategory}
										</MenuItem>
									);
								})}
